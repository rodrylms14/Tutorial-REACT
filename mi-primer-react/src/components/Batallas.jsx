...
function Batallas() {
  ...
  return (
    <div className="container-batallas">
      <h2 className="tittle-1">Simulación de Batallas</h2>

      <h3 className="tittle-2">Ranking</h3>
      <ol className="lista-1">
        {[...jugadores]
      ...
      <h3 className="tittle-3">Últimas batallas</h3>
